...
urlpatterns = [
    ...
    path('appointments/<int:pk>/status/', views.appointment_status_update, name='status_update'),
    path('appointments/<int:pk>/start/', views.appointment_start, name='start'),
    path('appointments/<int:pk>/finish/', views.appointment_finish, name='finish'),
